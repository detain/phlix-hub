...
/**
 * Immutable result of a core (hub application) update check (S75).
 *
 * Returned by {@see CoreUpdateCheckService::status()} and serialised straight
 * onto `GET /api/v1/admin/updates/status`. Field names are camelCase because
 * the shared `@phlix/ui` admin console consumes them directly.
 *
 * `updateCommand` is a copy-to-clipboard string ONLY: the hub never runs
...
{
    /**
     * @param string      $currentVersion  Compiled {@see \Phlix\Hub\Version::VERSION}.
