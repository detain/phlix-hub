...
class StructuredLogger
{
    ...
    public function __construct(string $channel, array $config)
    {
        ...
        // loop" and DROPS the record (seen as bursts of "A possible infinite
        // logging loop was detected and aborted" during relay reconnects). No
        // handler or processor here emits its own log, so there is no real cycle
        // to detect — disable the guard so concurrent coroutine logging is safe.
